...
export class LowComponent {
  ...
  abonentCreate() {
    if (this.abonentCreateForm.controls.login.value != null &&
      ...
      this.apiService.createAbonent("low",
        new Abonent(
          0,
  ...
  abonentGet() {
    if (this.abonentGetForm.controls.id.value != null) {
      this.apiService.getAbonent("low", this.abonentGetForm.controls.id.value)
  ...
  abonentUpdate() {
    if (
      ...
      this.apiService.updateAbonent("low",
        new Abonent(
  ...
  cardCreate() {
    if (
      ...
      this.apiService.createCard("low", new Card(
          0,
  ...
  cardGet() {
    ...
    if (this.cardGetForm.controls.id.value != null)
      ...
      this.apiService.getCard("low", this.cardGetForm.controls.id.value)
        .pipe(take(1)).subscribe(e =>
        alert(JSON.stringify(e))
      )
  }
