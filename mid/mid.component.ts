...
export class MidComponent {
  ...
  abonentCreate() {
    if (this.abonentCreateForm.controls.login.value != null &&
      ...
      this.apiService.createAbonent("medium",
        new Abonent(
          0,
  ...
  abonentGet() {
    if (this.abonentGetForm.controls.id.value != null) {
      this.apiService.getAbonent("medium", this.abonentGetForm.controls.id.value)
  ...
  abonentUpdate() {
    if (
      ...
      this.apiService.updateAbonent("medium",
        new Abonent(
  ...
  cardCreate() {
    if (
      ...
      this.apiService.createCard("medium", new Card(
          0,
  ...
  cardGet() {
    ...
    if (this.cardGetForm.controls.id.value != null)
      ...
      this.apiService.getCard("medium", this.cardGetForm.controls.id.value)
        .pipe(take(1)).subscribe(e =>
        alert(JSON.stringify(e))
      )
  }
